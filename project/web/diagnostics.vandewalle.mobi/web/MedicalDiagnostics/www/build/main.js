...
var Diagnose2Page = /** @class */ (function () {
    ...
    Diagnose2Page.prototype.getBodyparts = function (ev, symptom) {
        ...
        if (val && val.trim() != '' && val.trim().length > 2) {
            var url_1 = "http://diagnostics.vandewalle.mobi/Backend/Bodypart/get_bodyparts/" + val.trim();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_auth_service_auth_service__ = __webpack_require__(103);
