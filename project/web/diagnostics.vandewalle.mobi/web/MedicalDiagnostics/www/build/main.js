    ...
    LoginPage.prototype.login = function () {
        ...
        this.auth.login(this.registerCredentials).subscribe(function (allowed) {
            if (allowed) {
                ...
                _this.storage.set('userName', _this.registerCredentials.email);
                var test = _this.storage.get('userName');
                console.log("setting username");
                _this.nav.setRoot('PatientsPage');
                _this.nav.setRoot('PatientsPage');
            }
            else {
...
var DiagnosePage = /** @class */ (function () {
    function DiagnosePage(navCtrl, navParams) {
    ...
    DiagnosePage.prototype.itemSelected = function (item) {
        console.log(item);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_diagnose_diagnose__ = __webpack_require__(198);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__pages_diagnose_diagnose__["a" /* DiagnosePage */]
            ],
            imports: [
